...
<template>
  <div>
    <!-- Page Header Start -->
    <PageHeader pageName="HỒ SƠ CỦA TÔI"></PageHeader>
    <!-- Page Header End -->
    <!-- Checkout Start -->
              ...
              <div class="card-body">
                ...
                <ul class="list-group list-group-flush">
                  ...
                  <li
                    class="list-group-item d-flex justify-content-between align-items-center flex-wrap"
                  >
                    <h6 class="mb-0">Đánh Giá Của Tôi:</h6>
                  ...
                  <div class="col-sm-9 text-secondary">
                    ...
                    <template v-if="errorData">
                      <template v-if="errorData['password_confirmation']">
                        <small
                          v-if="errorData['password_confirmation'][0]"
                          class="error fw-lighter text-danger text-lg mx-3"
                          >{{ errorData["password_confirmation"][0] }}</small
                        >
                      </template>
                    </template>
                  </div>
