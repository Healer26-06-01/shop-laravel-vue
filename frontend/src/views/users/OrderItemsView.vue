    ...
    useAxios
      ...
      .then((response) => {
        ...
        if (responseData.value.orderItems.length == 0)
          useAlert().centerDialogAlert("info", "Danh sách đơn hàng trống");
      })
      .catch((error) => {
...
<template>
  <div>
    <!-- Page Header Start -->
    <PageHeader pageName="DANH SÁCH ĐƠN HÀNG"></PageHeader>
    <!-- Page Header End -->
    <!-- Cart Start -->
    <div class="container">
      <article class="card">
        <template v-if="responseData">
          <div class="card-body">
            <div class="d-lg-flex justify-content-between">
              ...
              <h6 v-if="responseData.orderItems[0].payment_status == '0'">
                Trạng thái thanh toán: Chưa thanh toán
              </h6>
              <h6 v-else>Trạng thái thanh toán: Đã thanh toán</h6>
            </div>
            <article class="card">
              <div class="card-body row">
                <div class="col-lg">
                  <strong style="color: #1c1c1c !important">Tên:</strong>
                ...
                <div class="col-lg">
                  <strong style="color: #1c1c1c !important">Email:</strong>
                  <br />{{ responseData.orderItems[0].email }}
                </div>
                <div class="col-lg">
                  <strong style="color: #1c1c1c !important">Thành phố:</strong>
                  <br />{{ responseData.orderItems[0].city }}
                </div>
                <div class="col-lg">
                  <strong style="color: #1c1c1c !important">Tiểu bảng:</strong>
                  <br />{{ responseData.orderItems[0].state }}
                </div>
                <div class="col-lg">
                  <strong style="color: #1c1c1c !important">Địa chỉ:</strong>
            ...
            <div class="track">
              ...
              <div :class="[Shipped ? 'active' : '', 'step']">
                ...
                <span class="text">Đã được lấy bởi người giao hàng</span>
              </div>
              ...
              >
                <li class="col-md-4">
                  <figure class="itemside mb-3">
                    <div class="aside">
                      <img :src="data.image" class="img-sm border" />
                    </div>
            ...
            <article class="card">
              <div class="card-body row">
                ...
                >
                  <strong style="color: #1c1c1c !important"
                    >Tổng giảm giá:</strong
                  >
                  <br />
                  <template v-if="responseData.orderItems[0].c_discount">
                    ${{
                      (discount =
                        parseInt(responseData.orderItems[0].discount_price) +
                        parseInt(responseData.orderItems[0].c_discount))
                    }}
                  </template>
                  <template v-else
                    >${{
                      (discount = Math.ceil(
                        responseData.orderItems[0].discount_price
                      ))
                    }}</template
                  >
                </div>
                <div class="col-lg">
                  <strong style="color: #1c1c1c !important">Tổng phụ:</strong>
                  <br />${{ Math.ceil(responseData.orderItems[0].subtotal) }}
                </div>
                <div class="col-lg">
                  <strong style="color: #1c1c1c !important">Tổng cộng:</strong>
            ...
            <div class="d-flex justify-content-between">
              ...
              <button
                v-if="responseData.orderItems[0].payment_status == '0'"
