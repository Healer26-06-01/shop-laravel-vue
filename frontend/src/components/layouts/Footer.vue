  ...
  <div class="container-fluid bg-secondary text-dark mt-5 pt-5 b-bg-color">
    <div class="row px-xl-5 pt-5">
      <div class="col-lg-6 col-md-12 mb-5 pr-3 pr-xl-5">
        ...
        <p class="mb-0">
          <i class="fa fa-phone-alt text-primary mr-3"></i>+880{{
            settings.phone
          }}
        </p>
      </div>
            ...
            <div class="d-flex flex-column justify-content-start">
              ...
              <RouterLink :to="{ name: 'shop' }">
                <a class="text-dark mb-2" href="shop.html"
                  ><i class="fa fa-angle-right mr-2"></i>Cửa hàng của chúng
                  tôi</a
                >
              </RouterLink>
          ...
          <div class="col-md-6 mb-5">
            ...
            <div class="d-flex flex-column justify-content-start">
              <RouterLink :to="{ name: 'contactUs' }">
                <a class="text-dark"
                  ><i class="fa fa-angle-right mr-2"></i>Liên hệ với chúng
                  tôi</a
                >
              </RouterLink>
            </div>
    ...
    <div class="row border-top border-light mx-xl-5 py-4">
      <div class="col-md-10 px-xl-0">
        <p class="mb-md-0 text-center text-md-left text-dark">
          ...
          >.  -->
          Tất cả các quyền. Thiết kế bởi
          <a
            class="text-dark font-weight-semi-bold"
            href="https://www.facebook.com/healer26062001/"
            >Healer</a
          >
        </p>
      </div>
