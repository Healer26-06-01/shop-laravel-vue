...
<template>
  <div v-if="responseData" class="col-lg-3 col-md-12">
                    ...
                    <li>
                      ...
                      <ul>
                        <template v-if="cateData.sub_category">
                          <template
                            v-for="(
                              subCateData, subCateKey
                            ) in cateData.sub_category"
                            :key="subCateKey"
                          >
                            <li>
                              <RouterLink
    ...
    <template v-if="responseData.sidebarFilter">
      <div class="border-bottom mb-4 pb-4">
        <template v-for="(data, key) in responseData.sidebarFilter" :key="key">
          <h5 class="font-weight-semi-bold mb-4 mt-5">
            Filter by {{ data.name }}
          </h5>
          <template
            v-for="(dataOption, keyOption) in data.attribute_option"
            :key="keyOption"
          >
            <form>
              <div
              ...
              >
                <input
                  ...
                  :checked="
                    attribute ? attribute.search(dataOption.value) !== -1 : null
                  "
                  :id="dataOption.id"
    ...
    <div v-if="responseData.sidebarBrand" class="border-bottom mb-4 pb-4">
      <h5 class="font-weight-semi-bold mb-4">Tất cả thương hiệu</h5>
      <nav
      ...
      >
        <div class="navbar-nav w-100 overflow-hidden" style="height: 410px">
          <template v-for="(data, key) in responseData.sidebarBrand" :key="key">
            <RouterLink
              :to="{ name: 'brands', params: { slug: data.slug } }"
              style="text-decoration: none; color: inherit"
            >
