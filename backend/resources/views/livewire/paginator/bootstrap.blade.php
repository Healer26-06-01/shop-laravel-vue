<div>
    @if ($paginator->hasPages())
        ...
        <h6 class="text-left text-muted fw-bolder">Hiển thị từ
            {{ $paginator->currentPage() * $paginator->count() - $paginator->count() + 1 }} đến
            {{ $paginator->currentPage() * $paginator->count() }} trong tổng số {{ $paginator->total() }} mục</h6>
    @endif
</div>
