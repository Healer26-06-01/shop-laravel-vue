...
<div>
    ...
    <!-- End Sidebar-->
    <x-form pageTitle='Tạo Sản Phẩm' action='create' enctype="multipart/form-data">
        ...
        <x-form-input-field.select-for-array col="col-6" wireModel='stock_status' defaultOption='Chọn Trạng Thái Kho'
