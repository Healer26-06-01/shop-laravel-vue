...
<div>
    ...
    <x-form pageTitle='Update Editor' action='update'>
        ...
        <x-form-input-field.general col="col-6" lable="Editors phone" name="phone" type="text"
            wireModel='phone'>
        </x-form-input-field.general>
        ...
        <x-form-input-field.general col="col-6" lable="Editors address" name="address" type="text"
            wireModel='address'>
        </x-form-input-field.general>
        <x-form-input-field.general col="col-6" lable="Editors state" name="state" type="text"
            wireModel='state'>
        </x-form-input-field.general>
