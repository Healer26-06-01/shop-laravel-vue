...
<div>
    ...
    <x-form pageTitle='Tạo Danh Mục' action='update'>
        <x-form-input-field.general col="col-6" lable="Tên Danh Mục" name="name" type="text" wireModel='name'>
        </x-form-input-field.general>
        <x-form-input-field.select col='col-6' defaultOption='Chọn Danh Mục' :options='$categories' wireModel='category_id'
            colName='name' name="category_id">
